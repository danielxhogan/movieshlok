...
export default function HomePage() {
  ...
  const quotes = [
    ...
    <span key={7} className={styles["quote-text"]}>
      <p>
        &quot;Dear Siobhan, obviously I don&apos;t know what
        &quot;ensconced&quot; is.&quot;
      </p>
    ...
    <span key={9} className={styles["quote-text"]}>
      <p>
        &quot;I have a perfectly healthy brain, it just doesn&apos;t contain
        feelings.&quot;
      </p>
  ...
  return (
    <div className="wrapper">
      ...
      <div className={styles["quote-section"]}>
        <div
          className={`${styles["quote-pic"]} ${styles[quotePicClass]} content`}
        >
          <div className={styles["quote"]}>{quotes[quoteIdx]}</div>
      ...
      <div className={`${styles["features-section"]} content`}>
        <div className={`${styles["features"]}`}>
          <div className={styles["feature"]}>
            ...
            <div>
              <p>
                Use the searchbar to search for movies, cast & crew, or both
              </p>
            </div>
          ...
          <div className={styles["feature"]}>
            ...
            <div>
              <p>
                Click on a movie search result to watch the trailer, read the
                synopsis, or view details about cast & crew
              </p>
            </div>
            <Image
              src={movieDetailsImg}
          ...
          <div className={`${styles["feature"]} ${styles["last-feature"]}`}>
            ...
            <div>
              <p>
                On the movie details page you can read reviews left by other
                users
              </p>
              <p>
